...
2. Add init function `init{ModeName}()` in `js/router.js` or a new `practice-modes.js`
...
1. Create mode implementation in `js/reading-modes.js`
2. Register in `js/reading.js`
3. Add UI in `reading.html`
4. Add AI generation function in `js/reading-ai.js` if needed

## New AI Feature

1. Add function to `js/ai.js` (vocabulary), `js/reading-ai.js` (reading), or `js/writing-ai.js` (writing)
2. Export the function
3. Import and call from the appropriate page module
